<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:31447:"<!DOCTYPE html>
...
<head>
	...
	<link href="/attendchain/templates/protostar/favicon.ico" rel="shortcut icon" type="image/vnd.microsoft.icon" />
	<link href="/attendchain/components/com_breezingforms/libraries/jquery/tooltip.css" rel="stylesheet" />
	<link href="/attendchain/templates/protostar/css/template.css?3f137731dd969cb051c33a53d6497759" rel="stylesheet" />
...
display:none;
	...
	<script type="application/json" class="joomla-script-options new">{"csrf.token":"7853a9420df114e45378a0c7475c8e18","system.paths":{"root":"\/attendchain","base":"\/attendchain"}}</script>
	...
	<script src="/attendchain/templates/protostar/js/template.js?3f137731dd969cb051c33a53d6497759"></script>
...
<body class="site com_breezingforms view-form no-layout no-task itemid-110">
	<!-- Body -->
		...
		<div class="container">
			...
			<header class="header" role="banner">
				<div class="header-inner clearfix">
					<a class="brand pull-left" href="/attendchain/">
						<span class="site-title" title="ATTENDCHAIN">ATTENDCHAIN</span>											</a>
...
ff_processor.opsys='win';ff_processor.provider='Unknown';ff_processor.submitted='2019-04-19 14:12:53';ff_processor.form=5;ff_processor.form_id='ff_form5';ff_processor.page=1;ff_processor.target=1;ff_processor.runmode=0;ff_processor.inframe=0;ff_processor.inline=0;
...
<form data-ajax="false"  action="http://localhost/attendchain/index.php/en/?tp=1&templateStyle=7" method="post" name="ff_form5" id="ff_form5" enctype="multipart/form-data" accept-charset="utf-8" onsubmit="return false;" class="bfQuickMode">
