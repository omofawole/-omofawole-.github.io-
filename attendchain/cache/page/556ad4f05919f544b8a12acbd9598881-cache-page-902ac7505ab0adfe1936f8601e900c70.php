<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:36769:"<!DOCTYPE html>
...
display:none;
	...
	<script type="application/json" class="joomla-script-options new">{"csrf.token":"7853a9420df114e45378a0c7475c8e18","system.paths":{"root":"\/attendchain","base":"\/attendchain"},"system.keepalive":{"interval":840000,"uri":"\/attendchain\/index.php\/en\/component\/ajax\/?format=json"}}</script>
...
<![endif]-->
    ...
    <body class="site com-breezingforms view-form no-layout no-task itemid-110 en-gb ltr  sticky-header layout-fluid off-canvas-menu-init">
...
ff_processor.opsys='win';ff_processor.provider='Unknown';ff_processor.submitted='2019-04-19 14:13:15';ff_processor.form=5;ff_processor.form_id='ff_form5';ff_processor.page=1;ff_processor.target=1;ff_processor.runmode=0;ff_processor.inframe=0;ff_processor.inline=0;
...
<form data-ajax="false"  action="http://localhost/attendchain/index.php/en/?tp=1&templateStyle=9" method="post" name="ff_form5" id="ff_form5" enctype="multipart/form-data" accept-charset="utf-8" onsubmit="return false;" class="bfQuickMode">
...
<div style="clear:both; display: block; text-align: center; margin-top: 20px;"><span style="margin: 0 auto;">Powered by BreezingForms</span></div></div>
        ...
        <div class="offcanvas-menu">
            ...
            <div class="offcanvas-inner">
                                  <div class="sp-module "><h3 class="sp-module-title">Login Form</h3><div class="sp-module-content"><form action="http://localhost/attendchain/index.php/en/?tp=1&templateStyle=9" method="post" id="login-form">
	...
	<input type="hidden" name="return" value="aHR0cDovL2xvY2FsaG9zdC9hdHRlbmRjaGFpbi9pbmRleC5waHAvZW4vP3RwPTEmdGVtcGxhdGVTdHlsZT05" />
	<input type="hidden" name="7853a9420df114e45378a0c7475c8e18" value="1" />
	</form>
</div></div>
                            </div> <!-- /.offcanvas-inner -->
        </div> <!-- /.offcanvas-menu -->
